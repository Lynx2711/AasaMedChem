...
export default function AdminProductsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingProduct) {
      // Also pass is_active for updates
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-zinc-950 tracking-tight">Products</h1>
          <p className="text-sm text-zinc-500 mt-1">Manage active product catalog, stocks, and pricing.</p>
        </div>
        <button
      ...
      <div className="border border-zinc-200 rounded-lg bg-white overflow-hidden">
        {products.length === 0 ? (
          <div className="p-8 text-center text-zinc-500 text-sm">No products in catalog. Add one to get started.</div>
        ) : (
